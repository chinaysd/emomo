  ...
  75  000e 81            	ret
  78                     	xref	_UART_SentByte
 111                     ; 18 u8 Serial_SentByte(u8 data){
 112                     	switch	.text
 113  000f               _Serial_SentByte:
 117                     ; 21 	return UART_SentByte(data);
 119  000f cd0000        	call	_UART_SentByte
 123  0012 81            	ret
 126                     	xref	_UART_RevByte
 148                     ; 25 u8 Serial_RevByte(void){
 149                     	switch	.text
 150  0013               _Serial_RevByte:
 154                     ; 28 	return UART_RevByte();
 156  0013 cd0000        	call	_UART_RevByte
 160  0016 81            	ret
 ...
 206                     ; 36 	if(UART1_GetITStatus(UART1_IT_RXNE)!=RESET){
 208  0018 ae0255        	ldw	x,#597
 209  001b cd0000        	call	_UART1_GetITStatus
 211  001e 4d            	tnz	a
 212  001f 2747          	jreq	L101
 213                     ; 37 		res=UART1_ReceiveData8();
 215  0021 cd0000        	call	_UART1_ReceiveData8
 ...
 465                     	xref	_UART1_GetITStatus
 466                     	xref	_UART1_ReceiveData8
 486                     	end
