  ...
  57                     ; 13 		return GPIO_ReadInputPin(INT1_PORT, INT1_PIN);
  59  0005 4b10          	push	#16
  ...
  74                     ; 15 		return GPIO_ReadInputPin(INT2_PORT, INT2_PIN);
  76  0018 4b40          	push	#64
  77  001a ae500f        	ldw	x,#20495
 ...
 122                     ; 22 	GPIO_Init(INT1_PORT, INT1_PIN, GPIO_MODE_IN_PU_NO_IT);
 124  0029 4b40          	push	#64
 125  002b 4b10          	push	#16
 126  002d ae500f        	ldw	x,#20495
 127  0030 cd0000        	call	_GPIO_Init
 129  0033 85            	popw	x
 130                     ; 23 	GPIO_Init(INT2_PORT, INT2_PIN, GPIO_MODE_IN_PU_NO_IT); 
 132  0034 4b40          	push	#64
 133  0036 4b40          	push	#64
 134  0038 ae500f        	ldw	x,#20495
