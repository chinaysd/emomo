 ...
 174  0019 9e            	ld	a,xh
 175  001a c75347        	ld	21319,a
 176                     ; 68     TIM4->ARR = (uint8_t)(TIM4_Period);
 178  001d 9f            	ld	a,xl
 179  001e c75348        	ld	21320,a
 180                     ; 69 }
 183  0021 81            	ret
 ...
 334  0035 9e            	ld	a,xh
 335  0036 ca5343        	or	a,21315
 336  0039 c75343        	ld	21315,a
 338  003c 2009          	jra	L351
 339  003e               L151:
 340                     ; 121         TIM4->IER &= (uint8_t)(~TIM4_IT);
 342  003e 7b01          	ld	a,(OFST+1,sp)
 343  0040 43            	cpl	a
 344  0041 c45343        	and	a,21315
 345  0044 c75343        	ld	21315,a
 346  0047               L351:
 347                     ; 123 }
 350  0047 85            	popw	x
 351  0048 81            	ret
 ...
 567  0065 9e            	ld	a,xh
 568  0066 c75347        	ld	21319,a
 569                     ; 231     TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
 571  0069 9f            	ld	a,xl
 572  006a c75345        	ld	21317,a
 573                     ; 232 }
 576  006d 81            	ret
