...
typedef struct
{
  ...
  uint8_t Pushrod_A1_Status;
  uint8_t Pushrod_A2_Status;
  uint8_t Pushrod_B1_Status;
  uint8_t Pushrod_B2_Status;
  uint8_t Pushrod_C1_Status;
  uint8_t Pushrod_C2_Status;
  uint8_t Pushrod_reset;
  uint8_t Pushrod_All_Stop_Status;
  uint8_t Light_Flag;
  uint8_t Heat_Flag;
  uint8_t Mass_Flag;
  uint8_t Pushrod_All_Stop_Flag;  
}
bsp_status;
