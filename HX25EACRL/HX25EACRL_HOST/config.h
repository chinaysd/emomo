...
typedef unsigned char     u8;		 //	0 ~ 255	       (1 Byte)
typedef unsigned short    u16;		 //	0 ~ 65535      (2 Byte)
typedef unsigned long     u32;		 //	0 ~ 4294967295 (4 Byte)
typedef volatile unsigned long  vu32;
typedef volatile unsigned short vu16;
typedef volatile unsigned char  vu8;
//数据类型和范围 char -128 ~ +127 (1 Byte) ; short -32767 ~ + 32768 (2 Bytes)	;int -2147483648 ~ +2147483647 (4 Bytes) 


typedef bit 			BOOL; 		// 布尔变量（位变量）
typedef unsigned char	CHAR;		// 字符变量
typedef unsigned char 	INT8U; 		// 无符号8位整型变量  
typedef signed char 	INT8S; 		// 有符号8位整型变量  , signed char 的取值范围是 -128~127
typedef unsigned int 	INT16U; 	// 无符号16位整型变量 
typedef signed int 		INT16S; 	// 有符号16位整型变量 , signed int 的取值范围是 -32768~32767
typedef unsigned long 	INT32U; 	// 无符号32位整型变量
typedef signed long 	INT32S; 	// 有符号32位整型变量 , signed long 的取值范围是-2147483648~2147483647 (-2^31~2^31-1)
